          ...
          <div className="space-y-8 pb-12">
            {classes.map((classItem, index) => (
              ...
              >
                ...
                {/* Imagem ou Embed do Instagram */}
                <div className="w-full border-b border-slate-100">
                  {classItem.instagramUrl ? (
                    <iframe
                      src={`${classItem.instagramUrl.replace(/\/$/, '')}/embed`}
                      className="w-full"
                    ...
                    <div className="aspect-square bg-slate-100 flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 group">
