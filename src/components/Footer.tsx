    ...
    <footer className="bg-slate-900 text-slate-300 py-8 border-t border-slate-800 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
          ...
          {/* Brand & Description */}
          <div>
            <span className="text-2xl font-extrabold text-white tracking-tight flex items-center gap-3 mb-3">
          ...
          <div className="md:justify-self-end">
            <h3 className="text-white font-semibold mb-3 text-lg">Contato e Endereço</h3>
            <ul className="space-y-2 text-sm text-slate-400">
              <li><strong className="text-slate-300">Email:</strong> contato@uniconnect.edu.br</li>
